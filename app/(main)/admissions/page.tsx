...
export default async function AdmissionsPage({ searchParams }: { searchParams: AdmissionSearchParams }) {
  ...
  return <div className="min-h-screen bg-[#f0f4ff]">
    <section className="border-b border-gray-200 bg-white"><div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8"><p className="page-kicker mb-3">Admission calendar</p><h1 className="page-title">Never miss an admission deadline.</h1><p className="page-lede mt-4">Verified openings for schools, colleges and universities—with eligibility, entrance dates and original sources in one place.</p></div></section>
